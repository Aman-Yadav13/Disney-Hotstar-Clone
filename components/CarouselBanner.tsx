        ...
        {movies.map((movie) => (
          <div key={movie.id} className="flex-[0_0_100%] min-w-0 relative">
            <Image
              ...
              height={1080}
            />
            <div className="hidden md:inline absolute z-20 top-0 mt-0 pt-40 xl:pt-52 left-0 lg:mt-40 bg-transparent h-full w-full bg-gradient-to-r from-gray-900/90 via-transparent to-transparent p-10 space-y-5 text-white">
